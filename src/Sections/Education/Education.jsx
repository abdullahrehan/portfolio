...
const education = [
    {
        ...
        year: "2006-2017",
        grade: "B+",
        institute: "Suffa Secoundary School",
        certificate: "",
        image: <img src={suffa} className='w-[285px]' alt='asd' />,
...

    {
        ...
        year: "20017-2019",
        grade: "B+",
        institute: "Govt. College Muridke",
        certificate: "",
        image: <img src={suffa} className='w-[285px]' alt='asd' />,
        text: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing ."
    },

    {
        ...
        year: "2019-2024",
        grade: "Grade",
        institute: "COMSATS Universty Lahore",
        certificate: "",
        image: <img src={comsats} className='w-[285px]' alt='asd' />,
        text: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing ."
    },
]
                ...
                <div className='w-[100vw] md:w-[72%] md:h-full flex justify-start items-center h-[65%] bg-green-000 order-1 md:order-1 md:overflow-hidden overflow-x-scroll flex flex-col'>
                    ...
                    <div className='md:w-[85%] w-[185vw] h-[80%] pt-2 bg-green-00 '>
                        ...
                        {education.map(data =>
                            ...
                            <div className='w-full h-[25%] bg-orange-000 flex flex-row  border-t-2 divide-slate-200  rounded-[2px] hover:bg-[#EFEFEF] hover:rounded-[6px] hover:cursor-pointer' onClick={() => OpenInstitute(data)}>
